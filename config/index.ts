...
export const config = {
	...
	issueShortTermCredentials: process.env.ISSUE_SHORT_TERM_CREDENTIALS === 'true' || false,
	issueOneTimeCredentials: process.env.ISSUE_ONE_TIME_CREDENTIALS === 'true' || false,
